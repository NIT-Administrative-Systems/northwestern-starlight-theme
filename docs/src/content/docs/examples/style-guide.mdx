---
title: Style Guide
description: Live preview of Starlight components and markdown elements in the Northwestern theme.
sidebar:
    order: 1
    badge:
        text: Demo
...
Headings use **Noto Serif** (H1, H2) and **Poppins** (H3-H6) from the Northwestern CDN. Body text uses **Akkurat Pro**.
