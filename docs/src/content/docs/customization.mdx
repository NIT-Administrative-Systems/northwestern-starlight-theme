...
Each page gets a 1200x630 PNG at build time: title and description on Northwestern purple with a light purple accent border. Set `site` in your Astro config for absolute URLs. See [Getting Started](/getting-started/#open-graph-images) for setup.
